...
<html lang="en">
  ...
  <div class="d-flex h-100 w-100 mx-auto flex-column">
          ...
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="assets/img/anime1.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="assets/img/anime2.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="assets/img/anime3.jpg" class="d-block w-100" alt="...">
        ...
        <section class="section2 my-5">
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-12 col-md-4 col-lg-4 col-xl-4 mb-md-0 mb-lg-0 mb-xl-0"><div class="imagem imagem3"></div></div>
              </div>
            </div>
        </section>
      ...
      <footer class="text-center">
        <div class="container">
          <div class="row">
            <div class="col-sm-4 col-md-4 col-lg-4  col-xl-4 mb-5 mb-md-0  mb-lg-0 mb-xl-0">
              <h5>Menu</h5>
              <ul>
